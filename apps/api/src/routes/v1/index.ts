...
import timeSlotsRoutes from "./time-slots.routes.js";
...
export default async function v1Routes(app: FastifyInstance) {
  ...
  await app.register(catalogueRoutes, { prefix: "/catalogue" });
  ...
  await app.register(timeSlotsRoutes, { prefix: "/time-slots" });
