...
describe("approved live booking catalogue", () => {
  it("matches the complete approved DIY catalogue exactly", () => {
    expect(
      ...
      { categorySlug: "air-dry-cream-piping", slug: "air-dry-lamp", name: { en: "Lamp", zh: "台灯" }, priceMinCents: 4300, priceMaxCents: 4300, durationMinutes: 60, variantSelectedInStore: true, extraTimeMinutes: null, extraTimePriceCents: null },
      ...
      { categorySlug: "air-dry-cream-piping", slug: "air-dry-phone-case", name: { en: "Phone case", zh: "手机壳" }, priceMinCents: 6600, priceMaxCents: 6600, durationMinutes: 60, variantSelectedInStore: true, extraTimeMinutes: null, extraTimePriceCents: null },
