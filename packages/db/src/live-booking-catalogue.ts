...
export const LIVE_DIY_PROJECTS = [
  { categorySlug: "air-dry-cream-piping", slug: "air-dry-two-hair-clips", name: { en: "Two hair clips", zh: "一对发夹" }, priceMinCents: 1800, priceMaxCents: 1800, durationMinutes: 30, variantSelectedInStore: false },
  { categorySlug: "air-dry-cream-piping", slug: "air-dry-fridge-magnet", name: { en: "Fridge magnet", zh: "冰箱贴" }, priceMinCents: 1800, priceMaxCents: 1800, durationMinutes: 30, variantSelectedInStore: false },
  { categorySlug: "air-dry-cream-piping", slug: "air-dry-mini-drawers", name: { en: "Mini drawers", zh: "迷你抽屉" }, priceMinCents: 3200, priceMaxCents: 3200, durationMinutes: 30, variantSelectedInStore: false },
  { categorySlug: "air-dry-cream-piping", slug: "air-dry-hair-claw", name: { en: "Hair claw", zh: "抓夹" }, priceMinCents: 3200, priceMaxCents: 3200, durationMinutes: 30, variantSelectedInStore: false },
  { categorySlug: "air-dry-cream-piping", slug: "air-dry-car-decoration-stand", name: { en: "Car decoration stand", zh: "车载摆件支架" }, priceMinCents: 3800, priceMaxCents: 3800, durationMinutes: 30, variantSelectedInStore: false },
  { categorySlug: "air-dry-cream-piping", slug: "air-dry-medium-storage", name: { en: "Medium storage box/drawers", zh: "中号收纳盒／抽屉" }, priceMinCents: 6500, priceMaxCents: 6500, durationMinutes: 60, variantSelectedInStore: false },
  { categorySlug: "air-dry-cream-piping", slug: "air-dry-large-storage", name: { en: "Large storage box/drawers", zh: "大号收纳盒／抽屉" }, priceMinCents: 9800, priceMaxCents: 9800, durationMinutes: 60, variantSelectedInStore: false },
  { categorySlug: "air-dry-cream-piping", slug: "air-dry-glass-dome", name: { en: "Glass dome", zh: "玻璃罩" }, priceMinCents: 9800, priceMaxCents: 9800, durationMinutes: 60, variantSelectedInStore: false },
  { categorySlug: "air-dry-cream-piping", slug: "air-dry-extra-large-drawer", name: { en: "Extra-large drawer", zh: "超大号抽屉" }, priceMinCents: 19700, priceMaxCents: 19700, durationMinutes: 60, variantSelectedInStore: false },
  ...
  { categorySlug: "air-dry-cream-piping", slug: "air-dry-large-bag", name: { en: "Large bag to decorate", zh: "大包（可装饰）" }, priceMinCents: 10900, priceMaxCents: 10900, durationMinutes: 60, variantSelectedInStore: false },
  { categorySlug: "air-dry-cream-piping", slug: "air-dry-water-bottle", name: { en: "Water bottle", zh: "水瓶" }, priceMinCents: 8800, priceMaxCents: 8800, durationMinutes: 60, variantSelectedInStore: false },
  ...
  { categorySlug: "paint-clay", slug: "paint-clay-figurine-mini", name: { en: "Paint clay figurine — Mini", zh: "彩绘黏土摆件—迷你号" }, priceMinCents: 1980, priceMaxCents: 1980, durationMinutes: 60, variantSelectedInStore: false },
...
export const LIVE_PARTY_PACKAGES = [
  ...
  {
    slug: "party-150",
    name: { en: "150-minute party package", zh: "150分钟派对套餐" },
...
export const DECIDE_IN_STORE_OPTION = {
